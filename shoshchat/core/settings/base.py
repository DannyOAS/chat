"""Base settings for ShoshChat AI Django project."""
...
# Site Configuration
SITE_NAME: Final[str] = config("SITE_NAME", default="ShoshChat")
SITE_URL: Final[str] = config("SITE_URL", default="https://shoshchat.ai")
...
EMAIL_HOST: Final[str] = config("EMAIL_HOST", default="")
EMAIL_PORT: Final[int] = config("EMAIL_PORT", default=587, cast=int)
EMAIL_USE_TLS: Final[bool] = config("EMAIL_USE_TLS", default=True, cast=bool)
EMAIL_HOST_USER: Final[str] = config("EMAIL_HOST_USER", default="")
EMAIL_HOST_PASSWORD: Final[str] = config("EMAIL_HOST_PASSWORD", default="")
